...
QT_MOC_LITERAL(26, 296, 8) // "getTasks"
    ...
    "setHistoryRange\0start\0end\0switchMarked\0"
    "getTasks"
};
#undef QT_MOC_LITERAL
...
void DroneListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: { QVariant _r = _t->getTasks((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QVariant*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
