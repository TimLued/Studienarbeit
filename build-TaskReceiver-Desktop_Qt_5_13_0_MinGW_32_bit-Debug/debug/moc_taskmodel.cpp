...
#include <memory>
#include "../../TaskReceiver/taskmodel.h"
...
QT_MOC_LITERAL(2, 15, 9) // "TaskList*"

    },
    "TaskModel\0list\0TaskList*"
};
...
void TaskModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< TaskList**>(_v) = _t->list(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setList(*reinterpret_cast< TaskList**>(_v)); break;
        default: break;
        }
