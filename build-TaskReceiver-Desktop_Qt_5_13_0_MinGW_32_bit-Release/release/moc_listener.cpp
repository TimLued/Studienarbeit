...
#include <memory>
#include "../../TaskReceiver/listener.h"
...
QT_MOC_LITERAL(1, 9, 12), // "taskReceived"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "task"
QT_MOC_LITERAL(4, 28, 8), // "readTask"
QT_MOC_LITERAL(5, 37, 5), // "recon"
QT_MOC_LITERAL(6, 43, 11) // "requestTask"

    },
    "Listener\0taskReceived\0\0task\0readTask\0"
    "recon\0requestTask"
};
...
void Listener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->taskReceived((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->readTask(); break;
        case 2: _t->recon(); break;
        case 3: _t->requestTask(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Listener::taskReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Listener::taskReceived(QString _t1)
{
